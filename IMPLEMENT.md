...
Phases 1, 2A, 2B and 3 are complete in private owner/source release v24.6.230.
...
2. Read `CV_STUDIO_V24_6_230_PHASE_4_HANDOVER.md`.
3. Read
...
4. Verify the v24.6.230 source/package checksum against its adjacent SHA-256 and
   verification sidecars.
5. Verify Git and create a clean v24.6.230 baseline commit if the extracted
