...
Phases 1, 2A and 2B are complete in private owner/source release v24.6.220.
...
2. Read `CV_STUDIO_V24_6_220_PHASE_3_HANDOVER.md`.
3. Read `cv_studio_v24_6_220_phase2b_browser_storage_qa_report.md` and the historical Phase 2A QA reports.
4. Verify the v24.6.220 source/package checksum against its adjacent SHA-256 sidecar.
5. Verify Git and create a clean v24.6.220 baseline commit if the extracted folder is not already a repository.
