...
Phases 1, 2A and 2B are complete in private owner/source release v24.6.222.
...
2. Read `CV_STUDIO_V24_6_222_PHASE_3_HANDOVER.md`.
3. Read `cv_studio_v24_6_222_phase2b_second_corrective_review_qa_report.md`,
   the v24.6.221/v24.6.220 Phase 2B QA reports and the historical Phase 2A QA
   reports.
4. Verify the v24.6.222 source/package checksum against its adjacent SHA-256 sidecar.
5. Verify Git and create a clean v24.6.222 baseline commit if the extracted folder is not already a repository.
