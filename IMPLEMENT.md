...
Phases 1, 2A, 2B and 3 are complete in private owner/source release v24.6.223.
...
2. Read `CV_STUDIO_V24_6_223_PHASE_4_HANDOVER.md`.
3. Read `cv_studio_v24_6_223_phase3_shared_external_clients_qa_report.md`, the
   Phase 2B QA reports and the historical Phase 2A QA reports.
4. Verify the v24.6.223 source/package checksum against its adjacent SHA-256 and
   verification sidecars.
5. Verify Git and create a clean v24.6.223 baseline commit if the extracted
