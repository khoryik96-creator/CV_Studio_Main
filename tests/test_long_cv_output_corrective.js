...
// Frontend JS now lives in vendor/cvstudio/*.js modules (extracted from the old
// monolithic index.html). Search index.html (still holds the markup) plus every
// module so fn(name) finds each function wherever it was extracted to.
const html = fs.readFileSync('index.html', 'utf8') + '\n' +
  fs.readdirSync('vendor/cvstudio')
