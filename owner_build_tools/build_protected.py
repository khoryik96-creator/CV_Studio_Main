...
def validate_source(root: Path) -> None:
    required=("app.py","cvstudio_architecture.py","cvstudio_ai_costs.py","cvstudio_antiword.py","cvstudio_tesseract.py","cvstudio_clients.py","cvstudio_storage.py","cvstudio_storage_bridge.py","cvstudio_diagnostics.py","cvstudio_document_safety.py","cvstudio_jobs.py","cvstudio_startup.py","cvstudio_runtime.py","cvstudio_web_assets.py","cvstudio_secrets.py","cvstudio_jobadder_read.py","cvstudio_jobadder_write.py","cvstudio_onenote_text.py","index.html","generate.js","template.docx","package.json","requirements.txt","merge_title_cache.py") + tuple(
