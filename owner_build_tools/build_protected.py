...
def validate_source(root: Path) -> None:
    required=("app.py","cvstudio_clients.py","cvstudio_storage.py","cvstudio_storage_bridge.py","cvstudio_diagnostics.py","cvstudio_document_safety.py","index.html","generate.js","template.docx","package.json","requirements.txt","merge_title_cache.py")
...
def preflight_source(root: Path) -> None:
    run([sys.executable,"-m","py_compile",str(root/"app.py"),str(root/"cvstudio_clients.py"),str(root/"cvstudio_storage.py"),str(root/"cvstudio_storage_bridge.py"),str(root/"cvstudio_diagnostics.py"),str(root/"cvstudio_document_safety.py"),str(root/"merge_title_cache.py")])
