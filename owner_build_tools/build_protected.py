...
def validate_source(root: Path) -> None:
    required=("app.py","cvstudio_architecture.py","cvstudio_ai_costs.py","cvstudio_antiword.py","cvstudio_tesseract.py","cvstudio_clients.py","cvstudio_storage.py","cvstudio_storage_bridge.py","cvstudio_diagnostics.py","cvstudio_document_safety.py","cvstudio_jobs.py","cvstudio_startup.py","cvstudio_runtime.py","cvstudio_web_assets.py","cvstudio_secrets.py","cvstudio_jobadder_read.py","cvstudio_jobadder_write.py","cvstudio_onenote_text.py","cvstudio_outlook_crypto.py","cvstudio_cv_normalize.py","cvstudio_lead_match.py","cvstudio_lead_enrich.py","cvstudio_lead_cache.py","cvstudio_lead_search.py","cvstudio_spider_boolean.py","cvstudio_spider_summary.py","cvstudio_spider_score.py","cvstudio_ja_typos.py","cvstudio_salary_parse.py","cvstudio_ja_answers.py","cvstudio_ja_salary_notice.py","cvstudio_blind_mask.py","cvstudio_ppc.py","cvstudio_msgraph.py","cvstudio_onenote_desktop.py","index.html","generate.js","template.docx","package.json","requirements.txt","merge_title_cache.py") + tuple(
...
def preflight_source(root: Path, target: str | None = None) -> None:
    run([sys.executable,"-m","py_compile",str(root/"app.py"),str(root/"cvstudio_architecture.py"),str(root/"cvstudio_ai_costs.py"),str(root/"cvstudio_antiword.py"),str(root/"cvstudio_tesseract.py"),str(root/"cvstudio_clients.py"),str(root/"cvstudio_storage.py"),str(root/"cvstudio_storage_bridge.py"),str(root/"cvstudio_diagnostics.py"),str(root/"cvstudio_document_safety.py"),str(root/"cvstudio_jobs.py"),str(root/"cvstudio_startup.py"),str(root/"cvstudio_runtime.py"),str(root/"cvstudio_web_assets.py"),str(root/"cvstudio_secrets.py"),str(root/"cvstudio_jobadder_read.py"),str(root/"cvstudio_jobadder_write.py"),str(root/"cvstudio_onenote_text.py"),str(root/"cvstudio_outlook_crypto.py"),str(root/"cvstudio_cv_normalize.py"),str(root/"cvstudio_lead_match.py"),str(root/"cvstudio_lead_enrich.py"),str(root/"cvstudio_lead_cache.py"),str(root/"cvstudio_lead_search.py"),str(root/"cvstudio_spider_boolean.py"),str(root/"cvstudio_spider_summary.py"),str(root/"cvstudio_spider_score.py"),str(root/"cvstudio_ja_typos.py"),str(root/"cvstudio_salary_parse.py"),str(root/"cvstudio_ja_answers.py"),str(root/"cvstudio_ja_salary_notice.py"),str(root/"cvstudio_blind_mask.py"),str(root/"cvstudio_ppc.py"),str(root/"cvstudio_msgraph.py"),str(root/"cvstudio_onenote_desktop.py"),str(root/"merge_title_cache.py")]+[str(root/rel) for rel in SALARY_COMPARISON_MODULES])
