...
const BULLET_MATCH_STRIP_RE = /^(?:[•●▪◦‣⁃∙·‧*‐‑‒–—―-]\s+|[-–—](?:[0-9]{1,3}|[a-z]|[ivxlcdm]{1,4})[.)\-]*\s+|\((?:[0-9]{1,3}|[a-z]|[ivxlcdm]{1,4})\)[.)]*\s*|\(?(?:[0-9]{1,3}|[a-z]|[ivxlcdm]{1,4})[.)\-]+\s+)/i;
...
const LEADING_BULLET_MARKER_RE = /^(?:[•●▪◦‣⁃∙·‧*‐‑‒–—―-]\s+|[-–—](?:[0-9]{1,3}|[a-z]|[ivxlcdm]{1,4})[.)\-]*\s+|\((?:[0-9]{1,3}|[a-z]|[ivxlcdm]{1,4})\)[.)]*\s*|\(?(?:[0-9]{1,3}|[a-z]|[ivxlcdm]{1,4})[.)\-]+\s+)+/i;
