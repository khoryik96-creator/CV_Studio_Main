...
- PR #189 merged as `2c216c6`; PR #185 merged as `b84c36f`. Neither is an
  ...
  v24.6.382 on `codex/pr194-v24.6.382-async-handler-safety`; PR number is
...
- Status: PR #155 merged the v24.6.340 HTML-highlight corrective as `a25bf5b`.
  ...
  as `b52b5b0`.
- Current stop: v24.6.382 async-handler fixes are unmerged. PR #193 is merged. No release or native
  protected build is produced by this work; protected builds remain manual.

## v24.6.382 async-handler corrective (unmerged)
