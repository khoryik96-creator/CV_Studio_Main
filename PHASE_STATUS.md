...
3. Extract the complete optional pinned-navigation domain to one synchronous
   classic module at its exact former source position, retaining every global
   name and the relative `DOMContentLoaded` order.
