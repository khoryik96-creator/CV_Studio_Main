...
function cvStudioRefreshHydratedSettingUi(){
  ...
  try{window._cvBlindCandidateGenderNeutral=localStorage.getItem('cvstudio_blind_candidate_gender_neutral_v1')==='true';if(typeof renderCvBlindCandidateGenderNeutralizationSetting==='function')renderCvBlindCandidateGenderNeutralizationSetting();}catch(e){}
  try{window._cvAutoCorrectLanguage=localStorage.getItem('cvstudio_autocorrect_language_v1')==='true';if(typeof renderCvAutoCorrectLanguageSetting==='function')renderCvAutoCorrectLanguageSetting();}catch(e){}
...
function showSettingsTab(name) {
  name = name || 'routing';
  var suffixMap = {routing:'Routing', api:'Api', onenote:'OneNote', integrations:'Integrations', general:'General', downloads:'Downloads', background:'Background'};
  ['routing','api','onenote','integrations','general','downloads','background'].forEach(function(k){
  ...
  if (name === 'downloads' && typeof renderCvDownloadSettings === 'function') setTimeout(renderCvDownloadSettings, 0);
}
...
var LOCK_UNLOCK_VERSION = 'v24.6.377';
