...
function getTheSpiderInputs() {
  ...
  return {
    ...
    include_untagged_fields: !!(document.getElementById('theSpiderIncludeUntagged') || {}).checked,
    strategy: val('theSpiderStrategy'),
...
function buildTheSpiderSearchFilters(inp) {
  ...
  return {
    ...
    include_untagged_fields: !!inp.include_untagged_fields,
...
function clearTheSpider() {
  ...
  ackBrowserActivityForTab('thespider');
  ackBrowserActivityFailedForTab('thespider');
  ['theSpiderJdText','theSpiderCityState','theSpiderMust','theSpiderSalaryMin','theSpiderSalaryMax','theSpiderStrategy'].forEach(function(id){ var el=document.getElementById(id); if(el) el.value=''; });
  ...
  var includeUntagged=document.getElementById('theSpiderIncludeUntagged'); if(includeUntagged) includeUntagged.checked=false;
